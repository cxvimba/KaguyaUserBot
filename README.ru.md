...
<p style="text-align: center;">
  ...
  <br><br>
  <a href="https://github.com/cxvimba/kaguya-modules">📦 Официальный каталог модулей</a> •
  <a href="#3-установка-и-развертывание">📥 Установка и запуск</a> •
  <a href="#5-разработка-модулей-плагинов">🛠️ Разработка плагинов</a>
</p>
